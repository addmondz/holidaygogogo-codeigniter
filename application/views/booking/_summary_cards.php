    ...
    <div class="row">
        ...
        <?php if($show_tc) { ?>
            ...
            <div class="col-md-3 sc-pos-bottom">
                <div class="card card-custom">
                    <div class="card-header border-0 summary-card-header" style="background-color:#F5E6CD;">
                        <h3>Total Sales vs Target</h3>
                        <i id="pop-sales-month" class="la la-info-circle summary-info-icon" data-toggle="popover" data-trigger="hover focus" data-placement="bottom" data-html="true" title="How this is calculated" data-content="<strong>What it shows:</strong> Your total all-time sales compared against your target.<br><br><strong>Sales total:</strong> adds up the value of all your Booking Confirmations (across all dates), <strong>regardless of payment status</strong>. Quotations, proforma invoices and cancelled bookings are not included.<br><br><strong>Credit:</strong> same rule as &ldquo;BC Created&rdquo; (main sales person before 1 Jun 2026, second sales agent after).<br><br><strong>Target:</strong> set for each agent under Admin &rarr; Sales Targets. The percentage is your sales divided by your target."></i>
                    </div>
                    <div class="card-body summary-card-body">
