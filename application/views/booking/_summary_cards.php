            ...
            <div class="col-md-3 sc-pos-bottom">
                <div class="card card-custom">
                    <div class="card-header border-0 summary-card-header" style="background-color:#F5E6CD;">
                        ...
                        <i id="pop-sales-month" class="la la-info-circle summary-info-icon" data-toggle="popover" data-trigger="hover focus" data-placement="bottom" data-html="true" title="How this is calculated" data-content="<strong>What it shows:</strong> Your total sales this month compared against your monthly target.<br><br><strong>Sales total:</strong> adds up the value of your bookings that customers have <strong>fully paid</strong> this month. A booking only counts once the approved customer payments cover the full booking amount &mdash; part-paid or deposit-only bookings are not included.<br><br><strong>Credit:</strong> same rule as &ldquo;BC Created&rdquo; (main sales person before 1 Jun 2026, second sales agent after).<br><br><strong>Target:</strong> set for each agent under Admin &rarr; Sales Targets. The percentage is your sales divided by your target."></i>
                    </div>
                    <div class="card-body summary-card-body">
