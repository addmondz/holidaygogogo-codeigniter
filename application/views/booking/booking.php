                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    <input type="text" id="Customer" <?php if(current_url() == base_url('Booking/Update') || current_url() == base_url('Booking/Duplicate')) { ?> value="<?php echo $Customer; ?>" <?php } ?> autocomplete="off" class="form-control">
                                    <span>
