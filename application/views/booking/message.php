        ...
        <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image:url(<?php echo base_url('assets/image/login.jpg'); ?>);">
            <div class="login-form p-7 position-relative overflow-hidden">
                ...
                <div class="text-center">
                    <p>Thanks For Filling Up The Guest List, You May Continue To Fill Up The Guest List By Clicking Here 
                        <a href="<?php echo $url; ?>"><?php echo $url; ?></a>
                        <br>
                        If You Haven't Done Filling Up. 
                        <br><br> 
                        Your Customer Service Officer Will Get In Touch With You For Further Info And Procedure. 
                        <br><br> 
                        To Continue Shopping, Please Visit 
                        <a href="https://www.holidaygogogo.com">https://www.holidaygogogo.com</a>
                    </p>
                </div>
            </div>
        </div>
