                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="team_lead[]" data-live-search="true" class="form-control selectpicker" multiple data-actions-box="true" title="--ALL TEAMS--">
                                                    <?php foreach($lead_ownership_team_leads as $tl) { ?>
                                                        <option data-icon="la la-user-tie font-size-lg bs-icon" value="<?php echo html_escape($tl->TeamID); ?>" <?php if(in_array((string) $tl->TeamID, $lead_ownership_filters['team_lead'], true)) { echo 'selected'; } ?>>
