...
class Payment_Model extends CI_Model
{
	...
	function Create($count)
	{
		$array = array(
			...
			'SupplierID' => $this->input->post('debit_type-' . $count) == 'SUPPLIER PAYMENT' || $this->input->post('debit_type-' . $count) == 'DEPOSIT' || $this->input->post('debit_type-' . $count) == 'FULL' || $this->input->post('debit_type-' . $count) == 'ADDITIONAL PAYMENT' ? $this->input->post('supplier-' . $count) : null,
			'BookingProductID' => $this->input->post('debit_type-' . $count) == 'SUPPLIER PAYMENT' || $this->input->post('debit_type-' . $count) == 'DEPOSIT' || $this->input->post('debit_type-' . $count) == 'FULL' || $this->input->post('debit_type-' . $count) == 'ADDITIONAL PAYMENT' ? $this->input->post('booking_product-' . $count) : null,
			...
			'Debit' => ($this->input->post('debit_type-' . $count) == 'SUPPLIER PAYMENT' || $this->input->post('debit_type-' . $count) == 'CUSTOMER REFUND' || $this->input->post('debit_type-' . $count) == 'ONE-TIME PAYMENT' || $this->input->post('debit_type-' . $count) == 'AGENT COMMISSION' || $this->input->post('debit_type-' . $count) == 'BANK CHARGES' || $this->input->post('debit_type-' . $count) == 'AGENT COMMISSION FROM SUPPLIER' || $this->input->post('debit_type-' . $count) == 'CREDIT CARD CHARGES' || $this->input->post('debit_type-' . $count) == 'DEPOSIT' || $this->input->post('debit_type-' . $count) == 'FULL' || $this->input->post('debit_type-' . $count) == 'ADDITIONAL PAYMENT') && !empty($this->input->post('debit-' . $count)) ? str_replace(',', '', $this->input->post('debit-' . $count)) : 0.00,
			'Deadline' => $this->input->post('debit_type-' . $count) == 'SUPPLIER PAYMENT' || $this->input->post('debit_type-' . $count) == 'CUSTOMER REFUND' || $this->input->post('debit_type-' . $count) == 'ONE-TIME PAYMENT' || $this->input->post('debit_type-' . $count) == 'AGENT COMMISSION' || $this->input->post('debit_type-' . $count) == 'BANK CHARGES' || $this->input->post('debit_type-' . $count) == 'AGENT COMMISSION FROM SUPPLIER' || $this->input->post('debit_type-' . $count) == 'CREDIT CARD CHARGES' || $this->input->post('debit_type-' . $count) == 'DEPOSIT' || $this->input->post('debit_type-' . $count) == 'FULL' || $this->input->post('debit_type-' . $count) == 'ADDITIONAL PAYMENT' ? date('Y-m-d', strtotime(str_replace('/', '-', $this->input->post('payment_deadline-' . $count)))) : null,
			'QuotationNumber' => ($this->input->post('debit_type-' . $count) == 'SUPPLIER PAYMENT' || $this->input->post('debit_type-' . $count) == 'DEPOSIT' || $this->input->post('debit_type-' . $count) == 'FULL' || $this->input->post('debit_type-' . $count) == 'ADDITIONAL PAYMENT') && !empty($this->input->post('quotation_number-' . $count)) ? strtoupper($this->input->post('quotation_number-' . $count)) : null,
			'InvoiceNumber' => ($this->input->post('debit_type-' . $count) == 'SUPPLIER PAYMENT' || $this->input->post('debit_type-' . $count) == 'DEPOSIT' || $this->input->post('debit_type-' . $count) == 'FULL' || $this->input->post('debit_type-' . $count) == 'ADDITIONAL PAYMENT') && !empty($this->input->post('invoice_number-' . $count)) ? strtoupper($this->input->post('invoice_number-' . $count)) : null,
			'Currency' => ($this->input->post('debit_type-' . $count) == 'SUPPLIER PAYMENT' || $this->input->post('debit_type-' . $count) == 'CUSTOMER REFUND' || $this->input->post('debit_type-' . $count) == 'ONE-TIME PAYMENT' || $this->input->post('debit_type-' . $count) == 'AGENT COMMISSION' || $this->input->post('debit_type-' . $count) == 'BANK CHARGES' || $this->input->post('debit_type-' . $count) == 'AGENT COMMISSION FROM SUPPLIER' || $this->input->post('debit_type-' . $count) == 'CREDIT CARD CHARGES' || $this->input->post('debit_type-' . $count) == 'DEPOSIT' || $this->input->post('debit_type-' . $count) == 'FULL' || $this->input->post('debit_type-' . $count) == 'ADDITIONAL PAYMENT') && !empty($this->input->post('currency_code-' . $count)) ? $this->input->post('currency_code-' . $count) : null,
			'ForeignCurrency' => ($this->input->post('debit_type-' . $count) == 'SUPPLIER PAYMENT' || $this->input->post('debit_type-' . $count) == 'CUSTOMER REFUND' || $this->input->post('debit_type-' . $count) == 'ONE-TIME PAYMENT' || $this->input->post('debit_type-' . $count) == 'AGENT COMMISSION' || $this->input->post('debit_type-' . $count) == 'BANK CHARGES' || $this->input->post('debit_type-' . $count) == 'AGENT COMMISSION FROM SUPPLIER' || $this->input->post('debit_type-' . $count) == 'CREDIT CARD CHARGES' || $this->input->post('debit_type-' . $count) == 'DEPOSIT' || $this->input->post('debit_type-' . $count) == 'FULL' || $this->input->post('debit_type-' . $count) == 'ADDITIONAL PAYMENT') && !empty($this->input->post('foreign_currency-' . $count)) ? str_replace(',', '', $this->input->post('foreign_currency-' . $count)) : 0.00,
		...
		if($payment['Credit'] != 0.00) {
			...
			if($payment['Type'] == 'SUPPLIER PAYMENT' || ($payment['Debit'] > 0 && ($payment['Type'] == 'DEPOSIT' || $payment['Type'] == 'FULL' || $payment['Type'] == 'ADDITIONAL PAYMENT'))) {
...
return $query->result_array(); // instead of result()
	...
	function Read_Supplier_Payments_Breakdown()
	{
		...
		$this->db->where_in('Type', array('SUPPLIER PAYMENT', 'DEPOSIT', 'FULL', 'ADDITIONAL PAYMENT'));
