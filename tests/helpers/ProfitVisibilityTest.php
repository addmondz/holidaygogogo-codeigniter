 ...
 * front-line roles SALES AGENT (20), TEAM LEAD (25) and MARKETING (60) on the
 * booking list, the summary total, and the Excel export. Every other role keeps
 * seeing profit.
 */
...
// ---- Hidden for Sales Agent (20), Team Lead (25) and Marketing (60) ----------
assert_eq('sales agent(20) hides profit',   true,  admin_hides_profit(20));
assert_eq('team lead(25) hides profit',      true,  admin_hides_profit(25));
...
assert_eq('string "25" hides profit',        true,  admin_hides_profit('25'));
