...
foreach (array('Customer', 'Mobile', 'CountryCodeID', 'SalesAgent2', 'Destination', 'StartDate', 'EndDate', 'DepositDeadline', 'FullPaymentDeadline', 'BookingFormText') as $expected_key) {
