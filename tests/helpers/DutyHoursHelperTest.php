...
assert_eq('Wed 07:00 (start, inclusive)',  true,  is_within_duty_hours('2026-05-20 07:00:00'));
...
assert_eq('Wed 06:59 (before start)',      false, is_within_duty_hours('2026-05-20 06:59:00'));
assert_eq('Sun 10:00 (now included)',      true,  is_within_duty_hours('2026-05-17 10:00:00'));
...
assert_eq('clips before start',            1800, calculate_duty_response_seconds('2026-05-20 06:30:00', '2026-05-20 07:30:00'));
assert_eq('clips after end',               1800, calculate_duty_response_seconds('2026-05-20 21:30:00', '2026-05-20 22:30:00'));
assert_eq('overnight working seconds',    10800, calculate_duty_response_seconds('2026-05-20 21:00:00', '2026-05-21 09:00:00'));
assert_eq('sunday now included',            7200, calculate_duty_response_seconds('2026-05-17 10:00:00', '2026-05-17 12:00:00'));
